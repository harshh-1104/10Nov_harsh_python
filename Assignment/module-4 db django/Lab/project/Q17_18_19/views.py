...
@login_required(login_url='q17_18_19_login')
def profile_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('q17_18_19_profile')
    else:
        initial_data = {
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect('q17_18_19_verify_otp')
...
def verify_otp_view(request):
    if 'signup_data' not in request.session or 'otp' not in request.session:
        return redirect('q17_18_19_signup')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            if form.cleaned_data['otp'] == request.session['otp']:
                ...
                login(request, user)
                return redirect('q17_18_19_dashboard')
            else:
...
def logout_view(request):
    logout(request)
    return redirect('q17_18_19_login')
...
def transaction_list_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            transaction.save()
            return redirect('q17_18_19_transactions')
    else:
...
def category_list_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            category.save()
            return redirect('q17_18_19_categories')
    else:
        form = CategoryForm()
...
def budget_list_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('q17_18_19_budgets')
    else:
